...
const CheckoutPage = () => {
  ...
  const calculateTotal = () => {
    const taxRate = 0.1; // 10% taxes
    const shippingCost = 0; // Shipping cost
  ...
  const handlePayment = async () => {
    ...
    try {
      // Simuler une API backend pour créer une commande
      ...
      // Rediriger vers FedaPay pour le paiement
      window.location.href = paymentUrl;
    } catch (error) {
      console.error(error);
      setErrorMessage("Impossible de procéder au paiement.");
    }
  };
    ...
    <div>
      ...
      <div className="bg-gray-100 py-10 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-6">
          <h2 className="text-2xl font-bold mb-4">Informations de commande</h2>
          ...
          <div className="mt-6">
            ...
            <div className="flex justify-between py-2">
              <span>Total</span>
              <span className="font-bold">{calculateTotal().toFixed(2)} CFA</span>
            </div>
          </div>
