...
// import Image from "next/image"; // Utilisation de l'optimisation des images de Next.js
...
//     const isInWishlist = state.wishlist.find((item: Product) => item._id === product._id);
//     if (isInWishlist) {
//       dispatch({ type: "REMOVE_FROM_WISHLIST", payload: product._id });
//     } else {
//       dispatch({ type: "ADD_TO_WISHLIST", payload: { ...product, quantity: 1 } });
...
//                   onClick={() => handleToggleWishlist(product)}
//                   className={`text-white p-2 rounded-full transition ${
//                     state.wishlist.find((item: Product) => item._id === product._id)
//                       ? "bg-red-600 hover:bg-red-800"
//                       : "bg-blue-600 hover:bg-blue-800"
//                   }`}
//                 >
...
//             {/* Prix */}
//             <div className="flex items-center justify-between">
//               <span className="text-blue-800 font-bold">{product.finalPrice.toLocaleString()} CFA</span>
//               {product.discount && (
//                 <span className="text-gray-500 line-through text-sm ml-2">
