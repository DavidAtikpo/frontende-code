...
//         link.download = "contrat-vendeur-dubon.pdf";
//         link.click();
//         window.URL.revokeObjectURL(url); // Révoquer l'URL après usage
//       })
//       .catch(() => {
//         setError("Échec du téléchargement du contrat. Veuillez réessayer.");
//       });
//   };
...
//           </div>
//           {error && (
//             <p id="contract-error" className="text-sm text-red-500 mt-1">
//               {error}
//             </p>
//           )}
//         </div>
