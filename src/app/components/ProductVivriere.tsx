  ...
  if (loading) {
    return (
      <div className="min-h-[200px] flex flex-col items-center justify-center bg-gray-50">
        ...
        <p className="mt-4 text-gray-600">Chargement des produits vivriere...</p>
      </div>
    );
  }
  ...
  if (produitsFrais.length === 0) {
    return (
      <div className="min-h-[200px] flex flex-col items-center justify-center bg-gray-50">
        ...
        <p className="text-gray-600">Aucun produit vivriere disponible pour le moment.</p>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-2">
            Nos Produits Vivriere
          </h2>
          <p className="text-blue-100 max-w-2xl mx-auto">
            Découvrez notre sélection de produits vivriere de qualité
          </p>
        </motion.div>

        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {produitsFrais.slice(0, 20).map((product, index) => (
            <motion.div 
              key={product.id} 
