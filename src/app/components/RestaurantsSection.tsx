              ...
              <div className="flex space-x-3 md:space-x-4">
                {restaurants.map((restaurant, index) => (
                  <motion.div
                    ...
                    className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 w-[calc(33.333%-8px)] md:w-[calc(16.666%-12px)] flex-shrink-0"
                  >
